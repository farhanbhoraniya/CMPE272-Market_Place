    ...
    <div class="col text-center">
        <div class="block-27">
            <ul>
                ...
                <li class="active" ><a href="marvel.php">Marvel Products</a></li>
                <br>
                <li  class="active"><a href="marvellmv.php">Most Visited</a></li>
                <li><a href="marvelhp.php">Highest Price</a></li>
                <li><a href="marvellp.php">Lowest Price</a></li>
                <li><a href="marvellexi.php">Sort A-Z</a></li>
            </ul>
        </div>
    </div>
</div>
